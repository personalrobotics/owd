...
bool ApplyEEForceTorque::ApplyForce(owd_msgs::ApplyEEForceTorque::Request &req,
				owd_msgs::ApplyEEForceTorque::Response &res) {
...
bool ApplyEEForceTorque::StopForce(owd_msgs::StopForce::Request &req,
			       owd_msgs::StopForce::Response &res) {
  stopforce=true;
  return true;
}

bool ApplyEEForceTorque::SetForceGains(owd_msgs::SetJointOffsets::Request &req,
...
void ApplyEEForceTorque::SetVibration(double hand_x, double hand_y, double hand_z,
...
ros::ServiceServer ApplyEEForceTorque::ss_ApplyForce,
  ApplyEEForceTorque::ss_SetForceGains;
...
bool ApplyEEForceTorque::Register() {
  ros::NodeHandle n("~");
  ss_ApplyForce = n.advertiseService("ApplyForce",&ApplyEEForceTorque::ApplyForce);
  ss_SetForceGains = n.advertiseService("SetForceGains",&ApplyEEForceTorque::SetForceGains);
