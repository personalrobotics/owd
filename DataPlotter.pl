...
#print {$GP[1]} "replot $f using 3 title \"traj time\"\n"; #traj_time
	...
	print {$GP[1]} "replot $f using 1:39 title \"J1 targ\"  with lines ls 1\n";
	print {$GP[1]} "replot $f using 1:2  title \"J1 act\"  with lines ls 8\n";
	print {$GP[1]} "replot $f using 1:10 title \"J2 traj\" with lines ls 16\n";
	print {$GP[1]} "replot $f using 1:40 title \"J2 targ\" with lines ls 2\n";
	print {$GP[1]} "replot $f using 1:3  title \"J2 act\"  with lines ls 9\n";
	print {$GP[1]} "replot $f using 1:11 title \"J3 traj\" with lines ls 17\n";
	print {$GP[1]} "replot $f using 1:41 title \"J3 targ\" with lines ls 3\n";
	print {$GP[1]} "replot $f using 1:4  title \"J3 act\"  with lines ls 10\n";
	print {$GP[1]} "replot $f using 1:12 title \"J4 traj\" with lines ls 18\n";
	print {$GP[1]} "replot $f using 1:42 title \"J4 targ\" with lines ls 4\n";
	print {$GP[1]} "replot $f using 1:5  title \"J4 act\"  with lines ls 11\n";
	print {$GP[1]} "replot $f using 1:13 title \"J5 traj\" with lines ls 19\n";
	print {$GP[1]} "replot $f using 1:43 title \"J5 targ\" with lines ls 5\n ";
	print {$GP[1]} "replot $f using 1:6  title \"J5 act\"  with lines ls 12\n";
	print {$GP[1]} "replot $f using 1:14 title \"J6 traj\" with lines ls 20\n";
	print {$GP[1]} "replot $f using 1:44 title \"J6 targ\" with lines ls 6\n";
	print {$GP[1]} "replot $f using 1:7  title \"J6 act\"  with lines ls 13\n";
	print {$GP[1]} "replot $f using 1:15 title \"J7 traj\" with lines ls 21\n";
	print {$GP[1]} "replot $f using 1:45 title \"J7 targ\" with lines ls 7\n";
	print {$GP[1]} "replot $f using 1:8  title \"J7 act\"  with lines ls 14\n";

	print {$GP[0]} "set title $f\n";
	print {$GP[0]} "  plot $f using 1:16 title \"X traj\" with lines ls 15\n";
	print {$GP[0]} "replot $f using 1:22 title \"X targ\" with lines ls 1\n";
	print {$GP[0]} "replot $f using 1:17 title \"Y traj\" with points\n";
	print {$GP[0]} "replot $f using 1:23 title \"Y targ\" with lines ls 2\n";
	print {$GP[0]} "replot $f using 1:18 title \"Z traj\" with lines ls 17\n";
	print {$GP[0]} "replot $f using 1:24 title \"Z targ\" with lines ls 3\n";
	print {$GP[0]} "replot $f using 1:19 axes x1y2 title \"roll traj\" with lines ls 4\n";
	print {$GP[0]} "replot $f using 1:20 axes x1y2 title \"pitch traj\" with lines ls 5\n";
	print {$GP[0]} "replot $f using 1:21 axes x1y2 title \"yaw traj\" with lines ls 6\n";
