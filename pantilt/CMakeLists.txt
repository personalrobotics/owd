...
rosbuild_add_executable(puck_polltest puck_polltest.cpp)
target_link_libraries(puck_polltest wamcan openwam ${CANBUS_LIBS})
rosbuild_add_compile_flags(puck_polltest "${CANBUS_DEFS}")
rosbuild_add_link_flags(puck_polltest "${CANBUS_LDFLAGS}")
