...
DataRecorder<canio_data> candata;
  ...
  int get_property_rt(int32_t nid, int32_t property, int32_t* value, int32_t usecs=2000, int32_t retries=0, int32_t *value2=NULL);
  ...
  int read_motor_positions(double* mpos);
  int read_joint_encoder_positions(double* jpos);
