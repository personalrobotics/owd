...
const int Puck::MAX_TRQ[8] = {0, 4860,  4860,  4860,  4320,  3900,  3900,  3200};
...
const int Puck::MAX_CLIPPABLE_TRQ_EXPECTED[8] = {0, 4860,  9720,  9720,  4320,  7800,  7800,  3200};
int Puck::MAX_CLIPPABLE_TRQ[8] = {0, 0, 0, 0, 0, 0, 0, 0};
