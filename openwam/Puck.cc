...
#else // HEAD
const int Puck::MAX_TRQ[2] = {3200, 1800};
//const int Puck::MAX_TRQ[2] = {600, 600};

/* This is calculated automatically in WAM::init();
 * it will probably be MAX_TRQ +/-1 for J1, J4, and J7,
 * and 2*MAX_TRQ +/- 1 for the differential joints,
 * but it also depends on IPNM. */
//const int Puck::MAX_CLIPPABLE_TRQ_EXPECTED[2] = {600, 600};
//const int Puck::MAX_CLIPPABLE_TRQ_EXPECTED[2] = {1741,1741};
const int Puck::MAX_CLIPPABLE_TRQ_EXPECTED[2] = {3200,1800};
int Puck::MAX_CLIPPABLE_TRQ[2] = {0, 0};
